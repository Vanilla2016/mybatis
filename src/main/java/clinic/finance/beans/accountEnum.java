...
public enum accountEnum {
	...
	//,CATERALLEN(3, 10.0, accountTypeEnum.BUSINESS.toString(), "CaterAllen", 0, "callen.login.", "loginUri", "callenHTML", new String [] {"user"}, "Error 404", true, true);//Welcome to Cater Allen Private Bank
